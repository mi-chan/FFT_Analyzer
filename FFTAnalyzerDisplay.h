...
enum State {
STATE_DEMO = 0, STATE_TITLE = 1,
STATE_FFT = 10, STATE_LOG = 11,
STATE_OTHERS = 12, STATE_CONFIG = 13,
STATE_MUSIC = 20, STATE_THERMO_HYGRO = 21,
STATE_RETURN = 22,
};
...
void drawMusicScaleAnalyzer(uint8_t* fhtData, int dataLength); void drawThermoHygrometer( oat *thermoData,  oat *hygroData, int DATA_LENGTH, bool ThermoMode);
void drawDisabledDialogbox(void);
